...
import { exportBackup, importBackup, LEGACY_STORAGE_KEY, loadState, saveState, STORAGE_KEY } from "./storage.js";
...
$("#confirm-reset").addEventListener("click",()=>{ localStorage.removeItem(STORAGE_KEY); localStorage.removeItem(LEGACY_STORAGE_KEY); state=createState(); $("#confirm-dialog").close(); render(); toast("Application reset"); });
